...
This is really useful for things like user profiles, catalogues and content that does not have a structure. JSON documents are great for these things because they can be different, from one another.
Example; MongoDB · CouchDB · Firestore

- **Column-Family Stores:**  Column-family NoSQL databases are also known as wide-column stores. These databases organize data into rows and columns within families. This is really useful because it gives us high write scalability.. It is also very good for storing sparse data because it does that very efficiently. These tables are built for Internet of Things logging and analytics at a big scale like the whole planet.
